...
const ListeProjets = [
    ...
    },
    {
        ...
        listLangages: "React / Typescript / Jest",
        presentation: "Cette application permet aux utilisateurs de lancer des dés parmi un panele prédéfini.\nJ'ai choisi de créer ce projet pour davantage me familiariser avec TypeScript et pour m'entraîner à faire des tests unitaires avec « Jest ».",
        details: "Les tests sont toujours en cours !",
